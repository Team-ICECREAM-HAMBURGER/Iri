...
public class GameControlSerializableDictionary {
    ...
    [System.Serializable] public class PlayerFamilyScriptableObject : SerializableDictionary<GameControlTypeManager.FamilyType, GameSaveDataFamilyScriptableObject> { }
